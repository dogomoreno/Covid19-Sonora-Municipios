...
Fechahoy <- "Al reporte del 16 de junio de 2021"
...
Letalidad <- Sonora.DF %>% ggplot(aes(x= Fecha, y= Letalidad)) +
  ...
  scale_x_date(expand=c(0,0), limits = c(as.Date("2020-04-01"), as.Date("2021-07-30")), date_breaks = "1 month", date_labels = "%B") +
  coord_cartesian(expand = FALSE, clip = 'off') +
  theme_bw() +
  temaejes +
