...
Fechahoy <- "Al reporte del 26 de julio de 2021"
...
Activos <- Sonora.DF %>% ggplot() +
  ...
  scale_y_continuous(expand = c(0, 0), limits= c(0,4100), breaks=seq(0,4100,1000)) +
  scale_x_date(expand=c(0,0), limits = c(as.Date("2020-06-19"), as.Date("2021-09-05")), date_breaks = "1 month", date_labels = "%B") +
  coord_cartesian(expand = FALSE, clip = 'off') +
  theme_bw() +
  temaejes +
  theme(legend.text = element_text(family = "Lato", size = 7), legend.background = element_rect(fill="transparent"),
