...
subtitulo <- "Incidencia semanal de casos de covid-19\nAl reporte del 12/08/2021"
Semanalab <- "Semanas de jueves a miércoles (por fecha de corte)"
marcas <- c( "Alta (100 o más)", "Substancial (50-99)", "Moderada (10-49)","Baja (+0-9)")
romp <- c("4", "3", "2", "1")
capt <- "Elaboración Luis Armando Moreno con información de la Secretaría de Salud del Estado de Sonora.| Se toma como fecha de corte el día anterior al informe."
