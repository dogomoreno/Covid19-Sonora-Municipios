...
### **Estatus de los casos confirmados**
```{r, include=FALSE}
Sonora.DF.hoy <- filter(Sonora.DF, Fecha == as.Date("2020-07-29"))
...
Estatustree <- ggplot(Sonora.DF.hoy, aes(area = Casos.confirmados, fill= Estatus, label= Sonora.DF.hoy$label)) + geom_treemap(color = "white", size=5) +
