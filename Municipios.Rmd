...
Mapa_casos <- ggplot(capa_munison_casos, aes(map_id = id)) +
    ...
    scale_fill_gradient(low = "#58BCBC", high = "black", limits = c(1,4700), breaks = c(1, 500, 1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500))+
    theme_void() +
...
Column
-----------------------------------------------------------------------
### Casos acumulados al 12 de julio de 2020 {data-width=500}
...
Column
-----------------------------------------------------------------------
### Días desde el último caso confirmado (corte al 12/07/2020)  {data-width=500}
...
Column
-----------------------------------------------------------------------
### Decesos acumulados al 12 de julio de 2020 {data-width=500}
...
Indicadores
=====================================
**Al 12 de julio de 2020**  [Descarga esta tabla](https://onedrive.live.com/download.aspx?resid=5ADDF6870413EAC9!32159&authkey=!AC27R9r4fs_DWP4)
```{r}
