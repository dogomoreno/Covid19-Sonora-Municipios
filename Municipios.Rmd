...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "19/08/2021", href: "http://www.luisarmandomoreno.com/", align: right }
    theme: flatly
    orientation: rows
---
<style>                     
...
mapacovid <- leaflet(capa_munison) %>% 
  ...
  addLegend(position = "topright", pal = incipal, values = ~capa_munison$IS, opacity=1, group= "INCIDENCIA", 
              labFormat = function(type, cuts, p) {  
               paste0(labs)} ,
