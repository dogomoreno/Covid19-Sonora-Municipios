...
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "03/09/2021", href: "http://www.luisarmandomoreno.com/", align: right }
    theme: flatly
    orientation: rows
---
<style>                     
...
```{r, include=FALSE}
POBMUN <- read_csv("Bases/POBMUN.csv", locale = locale(encoding = "ISO-8859-1"), col_types = cols(CVEGEO = col_character()))
