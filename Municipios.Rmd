...
Mapa_casos <- ggplot(capa_munison_casos, aes(map_id = id)) +
    ...
    scale_fill_gradient(low = "#58BCBC", high = "black", limits = c(1,6200), breaks = c(1, 1000, 2000, 3000, 4000, 5000, 6000))+
    theme_void() +
...
### **Casos acumulados al 19 de julio de 2020**
...
### **Días desde el último caso confirmado (corte al 19/07/2020)**  {data-width=500}
...
### **Decesos acumulados al 19 de julio de 2020** {data-width=500}
...
Decesossem <- group_by(Decesossemana, MUNICIPIO, Reporte) %>% summarise('DECESOS SEMANALES' = sum(NUEVOS), ACUMULADOS=max(DECESOS)) 
